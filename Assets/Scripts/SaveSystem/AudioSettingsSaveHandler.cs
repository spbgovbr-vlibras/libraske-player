...
public static class AudioSettingsSaveHandler
{
    ...
    public static bool IsMusicMuted() => PlayerPrefs.GetInt(SaveFields.MusicMute) == Boolean.TrueInt;
    ...
    public static void MuteMusic(Boolean shouldMute) => PlayerPrefs.SetInt(SaveFields.MusicMute, shouldMute.ToInt());
    ...
    public static void ResetSettings()
    {
        ...
        PlayerPrefs.SetInt(SaveFields.MusicMute, Boolean.FalseInt);
